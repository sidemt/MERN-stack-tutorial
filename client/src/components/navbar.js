...
// In this component we will create a navigation bar that will link to the required components.
  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div className="colapse navbar-collapse" id="navbarSupportedContent">
